...
import { GmtreMockApiReplyCallback } from './mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class GmtreMockApiHandler {
  request!: HttpRequest<any>;
  urlParams!: { [key: string]: string };

  // Private
  private _reply: GmtreMockApiReplyCallback = undefined;
   ...
   * @param callback
   */
  reply(callback: GmtreMockApiReplyCallback): void {
    // Store the reply
