...
export class ContactsMockApi {
  ...
  registerHandlers(): void {
    ...
    // @ Contacts - GET
    // -----------------------------------------------------------------------------------------------------
    this._gmtreMockApiService.onGet('api/apps/contacts/all').reply(() => {
      // Clone the contacts
    ...
    // @ Contact - POST
    // -----------------------------------------------------------------------------------------------------
    this._gmtreMockApiService.onPost('api/apps/contacts/contact').reply(() => {
    ...
    this._gmtreMockApiService
      ...
      .reply(({ request }) => {
        ...
        // Generate a new GUID
        newTag.id = GmtreMockApiUtils.guid();
