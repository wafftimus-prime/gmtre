...
export const defaultNavigation: GmtreNavigationItem[] = [
  {
    id: 'dashboards',
    title: 'Dashboards',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        title:
          'A multi line navigation item title example which works just fine',
        icon: 'heroicons_outline:check-circle',
        type: 'basic',
      },
    ],
...
export const compactNavigation: GmtreNavigationItem[] = [
  {
    id: 'dashboards',
    title: 'Dashboards',
    tooltip: 'Dashboards',
...
export const futuristicNavigation: GmtreNavigationItem[] = [
  {
    id: 'dashboards',
    title: 'DASHBOARDS',
    type: 'group',
...
export const horizontalNavigation: GmtreNavigationItem[] = [
  {
    id: 'dashboards',
    title: 'Dashboards',
    type: 'group',
