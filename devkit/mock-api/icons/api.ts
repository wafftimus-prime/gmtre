...
export class IconsMockApi {
  ...
  registerHandlers(): void {
    ...
    // @ Feather icons - GET
    // -----------------------------------------------------------------------------------------------------
    this._gmtreMockApiService.onGet('api/ui/icons/feather').reply(() => [
      200,
      {
        namespace: 'feather',
        name: 'Feather',
    ...
    // -----------------------------------------------------------------------------------------------------
    this._gmtreMockApiService.onGet('api/ui/icons/heroicons-solid').reply(() => [
      200,
      {
    ...
    // -----------------------------------------------------------------------------------------------------
    this._gmtreMockApiService.onGet('api/ui/icons/heroicons-mini').reply(() => [
      200,
      {
    ...
    // -----------------------------------------------------------------------------------------------------
    this._gmtreMockApiService.onGet('api/ui/icons/material-solid').reply(() => [
      200,
      {
        namespace: 'mat_solid',
        name: 'Material Solid',
