...
import { GmtreMockApiService } from '../config/mock-api.service';
import {
...
export class AcademyMockApi {
  ...
  registerHandlers(): void {
    ...
    // @ Categories - GET
    // -----------------------------------------------------------------------------------------------------
    this._gmtreMockApiService.onGet('api/apps/academy/categories').reply(() => {
    ...
    // @ Courses - GET
    // -----------------------------------------------------------------------------------------------------
    this._gmtreMockApiService.onGet('api/apps/academy/courses').reply(() => {
      // Clone the courses
