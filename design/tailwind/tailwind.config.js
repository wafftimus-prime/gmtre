...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: `"Roboto","Inter var", ${defaultTheme.fontFamily.sans.join(',')}`,
      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            color: 'var(--gmtre-text-default)',
            '[class~="lead"]': {
              color: 'var(--gmtre-text-secondary)',
            },
            a: {
              color: 'var(--gmtre-primary-500)',
            },
            strong: {
              color: 'var(--gmtre-text-default)',
            },
            ...
            'ul > li::before': {
              backgroundColor: 'var(--gmtre-text-hint)',
            },
            hr: {
              borderColor: 'var(--gmtre-border)',
            },
            blockquote: {
              color: 'var(--gmtre-text-default)',
              borderLeftColor: 'var(--gmtre-border)',
            },
            h1: {
              color: 'var(--gmtre-text-default)',
            },
            ...
            thead: {
              color: 'var(--gmtre-text-default)',
              borderBottomColor: 'var(--gmtre-border)',
            },
            'tbody tr': {
              borderBottomColor: 'var(--gmtre-border)',
            },
