...
import { AgPromise, ComponentUtil, GridApi, ColumnApi, GridOptions, GridParams, Module, createGrid } from "@gmtre-datagrid/core";
...
export class AgGridAngular<TData = any, TColDef extends ColDef<TData> = ColDef<any>> implements AfterViewInit, OnChanges, OnDestroy {
    ...
    /** Exceeded the `pivotMaxGeneratedColumns` limit when generating columns.
         */
    @Output() public pivotMaxColumnsExceeded: EventEmitter<PivotMaxColumnsExceededEvent<TData>> = new EventEmitter<PivotMaxColumnsExceededEvent<TData>>();
