...
import {VanillaFrameworkOverrides, FrameworkOverridesIncomingSource} from "@gmtre-datagrid/core";
...
export class AngularFrameworkOverrides extends VanillaFrameworkOverrides {
    ...
    wrapIncoming: <T>(callback: () => T, source?: FrameworkOverridesIncomingSource) => T  = (callback, source) => this.runOutside(callback, source);
