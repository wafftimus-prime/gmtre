    ...
    private static setModuleBased(moduleBased: boolean) {
        if (ModuleRegistry.moduleBased === undefined) {
            ...
            if (ModuleRegistry.moduleBased !== moduleBased) {
                doOnce(() => {
                    console.warn(`AG Grid: You are mixing modules (i.e. @gmtre-datagrid/core) and packages - you can only use one or the other of these mechanisms.`);
...
For more info see: https://ag-grid.com/javascript-data-grid/getting-started/#getting-started-with-ag-grid-enterprise`;
    ...
    import { ModuleRegistry } from '@gmtre-datagrid/core';
...
For more info see: https://www.ag-grid.com/javascript-grid/packages/`;
    ...
    public static __warnEnterpriseChartDisabled(chartType: ChartType): void {
        ...
        const warningMessage = `AG Grid: the '${chartType}' chart type is not supported in AG Charts Community as 'ag-grid-charts-enterprise' or '@gmtre-datagrid/charts-enterprise' hasn't been loaded. See ${url} for more details.`;
