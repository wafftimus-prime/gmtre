...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private _gmtrePlatformConfigService: GmtrePlatformConfigService,
  ...
  ngOnInit(): void {
    ...
    combineLatest([
      ...
      this._gmtreMediaWatcherService.onMediaQueryChange$([
    ...
    this._renderer2.addClass(
      this._document.body,
      this._gmtrePlatformConfigService.osName
    );
  }
  ...
  private _updateLayout(): void {
    ...
    const layoutFromQueryParam: any =
    ...
    if (route.snapshot.data && route.snapshot.data['layout']) {
