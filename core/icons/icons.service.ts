...
export class IconsService
{
    ...
    constructor()
    {
        ...
        matIconRegistry.addSvgIconSetInNamespace('flat', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/gmtre_flat.svg'));
        matIconRegistry.addSvgIconSetInNamespace('logo', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/gmtre_logos.svg'));
    }
}
