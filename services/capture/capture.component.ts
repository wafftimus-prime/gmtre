...
import { CropDimensions, GmtreCaptureService } from './capture.service';
...
export class GmtreCaptureComponent implements OnInit {
  ...
  constructor(private captureService: GmtreCaptureService) {}
