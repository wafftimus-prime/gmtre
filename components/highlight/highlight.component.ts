...
import { GmtreHighlightService } from './highlight.service';

@Component({
  selector: 'textarea[gmtre-highlight]',
  templateUrl: './highlight.component.html',
  styleUrls: ['./highlight.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  exportAs: 'gmtreHighlight',
  standalone: true,
  imports: [NgClass],
})
export class GmtreHighlightComponent implements OnChanges, AfterViewInit {
  @Input()
  code!: string;
  @Input()
  lang!: string;
  ...
  highlightedCode!: string|any;
  private _viewRef!: EmbeddedViewRef<any>|any;
  ...
  constructor(
    ...
    private _gmtreHighlightService: GmtreHighlightService,
  ...
  private _highlightAndInsert(): void {
    ...
    this.highlightedCode = this._domSanitizer.sanitize(
      ...
      this._gmtreHighlightService.highlight(this.code, this.lang)
    );
