...
@Component({
    selector     : 'gmtre-masonry',
    templateUrl  : './masonry.component.html',
    encapsulation: ViewEncapsulation.None,
    animations   : gmtreAnimations,
    exportAs     : 'gmtreMasonry',
    standalone   : true,
    imports      : [NgTemplateOutlet],
})
export class GmtreMasonryComponent implements OnChanges, AfterViewInit
{
    @Input()
     ...
     * Constructor
     */
    constructor(private _gmtreMediaWatcherService: GmtreMediaWatcherService)
    {
    }
