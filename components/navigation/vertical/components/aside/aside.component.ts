...
import { GmtreVerticalNavigationComponent } from '../../../vertical/vertical.component';
...
@Component({
  selector: 'gmtre-vertical-navigation-aside-item',
...
export class GmtreVerticalNavigationAsideItemComponent
